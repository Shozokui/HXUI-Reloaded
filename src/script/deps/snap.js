...
!(function (a) {
  ...
  (function (a, b) {
    ...
    var c = (function (b) {
      var c = {},
        ...
        l = function (a) {
          ...
          return null == a
            ? b.dur
            : ((b.s = (b.s * a) / b.dur), (b.dur = a), void 0);
        },
        m = function () {
          var a = this;
    ...
    !(function () {
      function a(a) {
        a = a || Object(a);
        for (var b, d, e = 1, f = a.length + 1, h = c(a, 0); f > e; e++)
          (b = d),
            (d = h),
            (h = c(a, e)),
            (this.raw += d),
      ...
      function e(a, c, d) {
        "function" == typeof b &&
          b("elemental." + a + (c ? "." + c : ""), null, c, d || "", this.raw);
        for (var e = this.events && this.events[a], f = e && e.length; f--; )
          try {
      ...
      function h(b, c) {
        ...
        return (
          (g.mode = "text"),
          (g.type = String(b || "html").toLowerCase()),
          (g.textchunk = ""),
          (g.raw = ""),
          (g.parse = a),
          (g.on = d),
      ...
      var i = {
        ...
        k = function (a) {
          ...
          return (
            "#" == a.charAt() &&
              (b =
                "x" == a.charAt(1).toLowerCase()
                  ? parseInt(a.substring(2), 16)
                  : parseInt(a.substring(1), 10)),
            (b = i[a]),
            b ? String.fromCharCode(b) : "&" + a
          );
        },
        l = function () {
          for (var a in this.attr)
            this.attr.hasOwnProperty(a) &&
              this.event("attr", a, {
                value: this.attr[a],
        ...
        m = {
          ...
          entity: function (a) {
            j.test(a)
              ? ((this.textchunk += k(this.entity)), (this.mode = "text"))
              : ";" == a
              ? ((this.textchunk += k(this.entity + a)), (this.mode = "text"))
              : (this.entity += a);
          },
          special: function (a, b, c) {
            return "!" == c && "-" == a && "-" == b
              ? ((this.mode = "comment start"), void 0)
              : "[CDATA" == this.textchunk && "[" == a
          ...
          declaration: function (a, b) {
            return "?" == a && ">" == b
              ...
              : ("eof" == a && this.event("comment", this.textchunk),
                (this.textchunk += a),
                void 0);
          },
          ...
          "attr value": function (a, b, c) {
            if (j.test(a) && !this.quote) this.mode = "attr start";
              ...
              this.event("tag", this.tagname, this.attr), (this.mode = "text");
          },
        };
      (h.version = "0.2.4"),
        (("undefined" == typeof exports ? this : exports).elemental = h);
    })();
    var d = (function () {
      function d(a, b) {
        if (a) {
        ...
        if (b) {
          if (("string" == typeof a && (a = e(a)), "string" == typeof b))
            return "xlink:" == b.substring(0, 6)
              ? a.getAttributeNS(gb, b.substring(6))
              : a.getAttribute(b);
          for (var c in b)
            if (b[J](c)) {
              var d = K(b[c]);
              d
                ? "xlink:" == c.substring(0, 6)
                  ? a.setAttributeNS(gb, c.substring(6), d)
                  : a.setAttribute(c, d)
                : a.removeAttribute(c);
            }
        ...
        return (
          (a = a.replace(/(?:^|\s)(\w+)\(([^)]+)\)/g, function (a, c, d) {
            return (
              ...
              "skewX" == c
                ? b.push(["m", 1, 0, N.tan(k(d[0])), 1, 0, 0])
                : "skewY" == c
                ? b.push(["m", 1, N.tan(k(d[0])), 0, 1, 0, 0])
      ...
      function r(a) {
        ...
        var b =
            a.paper ||
            (a.node.parentNode && d(a.node.parentNode)) ||
            d.select("svg") ||
            d(0, 0),
      ...
      (d._.clone = g),
        ...
        (d.Matrix = n),
        (d.getRGB = i(function (a) {
          if (!a || (a = K(a)).indexOf("-") + 1)
            return { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: mb };
          if ("none" == a)
            return { r: -1, g: -1, b: -1, hex: "none", toString: mb };
          if (
            (!(_[J](a.toLowerCase().substring(0, 2)) || "#" == a.charAt()) &&
              (a = jb(a)),
            !a)
          )
            return { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: mb };
      ...
      (d.color = function (a) {
        ...
        (d.parsePathString = function (a) {
          ...
          return (
            ...
            e.length ||
              K(a).replace(ab, function (a, b, d) {
                var f = [],
                  g = b.toLowerCase();
                if (
                  (d.replace(cb, function (a, b) {
                    b && f.push(+b);
                  }),
                  "m" == g &&
                    f.length > 2 &&
      ...
      (d._.transform2matrix = p),
        ...
        (function (a) {
          ...
          (a.attr = function (a, c) {
            ...
            (a.getBBox = function (a) {
              ...
              return a
                ? ((c.dirty || !c.bboxwt) &&
                    ((b.realPath = d.path.get[b.type](b)),
                    (c.bboxwt = d.path.getBBox(b.realPath)),
                    (c.bboxwt.toString = m),
                    (c.dirty = 0)),
                  d._.box(c.bboxwt))
                : ((c.dirty || c.dirtyT || !c.bbox) &&
                    ((c.dirty || !b.realPath) &&
                      ((c.bboxwt = 0), (b.realPath = d.path.get[b.type](b))),
          ...
          (d.animation = function (a, b, c, d) {
            ...
            (a.animate = function (a, d, e, g) {
              "function" != typeof e || e.length || ((g = e), (e = c.linear)),
                a instanceof k &&
                  ((g = a.callback), (e = a.easing), (d = e.dur), (a = a.attr));
              var i,
                j,
                l,
                m,
        ...
        (d.parse = function (a) {
          var c = I.doc.createDocumentFragment(),
            d = c;
          return (
            b.on("elemental.tag", function (a, b) {
              var c = e(a);
            ...
            (a.rect = function (a, b, c, d, e, g) {
              ...
              return (
                ...
                f(a, "object") && "x" in a
                  ? h.attr(a)
                  : null != a &&
                    (h.attr({ x: a, y: b, width: c, height: d }),
                    null != e && h.attr({ rx: e, ry: g })),
                h
              );
            }),
              ...
              (a.gradient = function (a) {
                ...
                (a.toString = function () {
                  ...
                  return (
                    b.appendChild(c),
                    c.appendChild(d),
                    e(d, { xmlns: "http://www.w3.org/2000/svg" }),
                    (a = c.innerHTML),
      ...
      return (
        ...
        b.on("snap.util.attr", function (a) {
          ...
          sb[J](this.type) && sb[this.type][J](c)
            ? null == a
              ? this.node.removeAttribute(c)
              : this.node.setAttribute(c, a)
            : (this.node.style[d] = null == a ? S : a);
        }),
        ...
        b.on("snap.util.getattr.r", function () {
          return "rect" == this.type && e(this.node, "rx") == e(this.node, "ry")
        ...
        b.on("snap.util.getattr", function () {
          ...
          return (
            ...
            sb[J](this.type) && sb[this.type][J](a)
          ...
          for (s = 0; h > s; s++)
            for (var u = 0; k > u; u++) {
              var v = m[s],
                ...
                x = o[u],
                y = o[u + 1],
                z = T(w.x - v.x) < 0.001 ? "y" : "x",
                A = T(y.x - x.x) < 0.001 ? "y" : "x",
                    ...
                    var e = h && j[b] ? j[b] : b,
                      f = function (e) {
                        ...
                        if (h && j[g](b))
                          for (
                            var p = 0,
                              q = e.targetTouches && e.targetTouches.length;
                            q > p;
                            p++
                          )
        ...
        (a.filter = {}),
          ...
          b.on("snap.util.attr.filter", function (a) {
            if (a instanceof c && "filter" == a.type) {
              b.stop();
              var d = a.node.id;
              d || (h(a.node, { id: a.id }), (d = a.id)),
                h(this.node, { filter: "url(#" + d + ")" });
            }
            (a && "none" != a) ||
